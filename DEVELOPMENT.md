...
* [Available scripts](#available-scripts)
  ...
  * [`generate:latexmarkupmap`](#generatelatexmarkupmap)
...
### `generate:latexmarkupmap`

Convert the icons and LaTeX commands used in the Component Formula Editor panel to static HTML markup text.

Examples:

```bash
npm run generate:latexmarkupmap
```
